 ...
 * @see 	 
 */
// two way: implements StatefulJob  or  use annotation of  @DisallowConcurrentExecution
//public class CustomJob implements StatefulJob{
@DisallowConcurrentExecution
public class SerialJobUseImpStatefulJob implements Job{
